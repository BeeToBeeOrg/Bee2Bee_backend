<template>
    ...
    <div class="container">
        ...
        <span id="invalid_login" v-if="!false_auth">Email is incorrect</span>
...
export default {
  ...
  methods: {
    // TODO: Add sign in with cognito
  async login() {
     
      const user = await this.$store.dispatch('auth/login',{userdata:this.user}).then((user)=>{
        console.log(this.$store.state.user);
        console.log("User: ",user)
        
      }).catch((err)=>{
        this.false_auth = true;
        console.log("ERRRROOROROR",err);
      })
